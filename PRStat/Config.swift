...
class Config {
    ...
    static func reviewsUrl(repository: Repository, pullNumber: Int) -> String {
        return "https://api.github.com/repos/zillyinc/\(repository.rawValue)/pulls/\(pullNumber)/reviews"
    }
}
